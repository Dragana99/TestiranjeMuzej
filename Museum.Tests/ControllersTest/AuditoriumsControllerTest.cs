...
namespace Museum.Tests.ControllersTest
{
    ...
    public class AuditoriumsControllerTest
    {
        ...
        [TestMethod]
        public void AuditoriumsController_GetByMuseumId_ReturnsListOfAuditoriums()
        {
            //Arrange
            ...
            AuditoriumsController auditoriumController = new AuditoriumsController(_mockAuditoriumService.Object);
            _mockAuditoriumService.Setup(x => x.GetAuditoriumByMuseumId(It.IsAny<int>())).Returns(responseTask);

            //Act
            var result = auditoriumController.GetByMuseumId(_auditoriumDomainModel.MuseumId).ConfigureAwait(false).GetAwaiter().GetResult().Result;
            ...
            Assert.AreEqual(auditoriumsDomainModelResultList[0].Id, _auditoriumDomainModel.Id);
            Assert.AreEqual(auditoriumsDomainModelResultList[0].MuseumId, _auditoriumDomainModel.MuseumId);
        }

        [TestMethod]
        public void AuditoriumsController_GetByMuseumId_ReturnNull()
        {
            //Arrange
            IEnumerable<AuditoriumDomainModel> auditoriums = null;
            Task<IEnumerable<AuditoriumDomainModel>> responseTask = Task.FromResult(auditoriums);
        ...
        public void AuditoriumsController_PostAsync_ReturnsInsertedAuditorium()
        {
            ...
            _mockAuditoriumService.Setup(x => x.CreateAuditorium(It.IsAny<AuditoriumDomainModel>())).Returns(responseTask);
            AuditoriumsController auditoriumController = new AuditoriumsController(_mockAuditoriumService.Object);
        ...
        public void AuditoriumsController_PostAsync_ThrowsDbUpdateException()
        {
            ...
            _mockAuditoriumService.Setup(x => x.CreateAuditorium(It.IsAny<AuditoriumDomainModel>())).Throws(dbUpdateException);
        ...
        public void AuditoriumsController_PostAsync_ReturnNull()
        {
            ...
            AuditoriumsController auditoriumController = new AuditoriumsController(_mockAuditoriumService.Object);
            _mockAuditoriumService.Setup(x => x.CreateAuditorium(It.IsAny<AuditoriumDomainModel>())).Returns(nullTask);
        ...
        public void AuditoriumsController_Put_ReturnsUpdatedAuditorium()
        {
            ...
            _mockAuditoriumService.Setup(x => x.UpdateAuditorium(It.IsAny<AuditoriumDomainModel>())).Returns(updated);
        ...
        public void AuditoriumsController_Put_ReturnNull()
        {
            ...
            _mockAuditoriumService.Setup(x => x.UpdateAuditorium(It.IsAny<AuditoriumDomainModel>())).Returns(nullTask);
